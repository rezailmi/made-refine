        ...
        {({ payload }) => (
          <TooltipPortal>
            <TooltipPositioner side="bottom" sideOffset={8} className="fixed z-[99999]">
              <TooltipPopup className="overflow-hidden rounded-md bg-foreground px-3 py-1.5 text-xs text-background animate-in fade-in-0 zoom-in-95 data-[closed]:animate-out data-[closed]:fade-out-0 data-[closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-2">
